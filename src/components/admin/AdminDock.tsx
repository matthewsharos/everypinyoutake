          ...
          {menuOpen && (
            <div className="flex flex-col items-end gap-2">
              <button
                ...
                className="flex min-w-40 items-center justify-between gap-3 rounded-full border border-line bg-white/95 px-3 py-2 text-sm font-semibold text-text shadow-xl backdrop-blur transition hover:-translate-y-0.5 hover:bg-white"
                onClick={() => {
                  setTool('archive');
                  setMenuOpen(false);
                }}
              >
                <span className="whitespace-nowrap">Search archive</span>
                <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-ink-2 text-muted">
              ...
              >
                <span className="whitespace-nowrap">Manual add</span>
                <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-ink-2 text-muted">
